                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="register-form text-center">
                            ...
                            <div class="input-box">
                                ...
                                <asp:DropDownList ID="Spot" runat="server" AppendDataBoundItems="True" DataMember="DefaultView" Height="30px" class="w16 form-control check-marks mb-15" ForeColor="Red" Font-Bold="True" required="required">
                                ...
                                <div class="w20 single-input-fields">
                                    ...
                                    <asp:TextBox ID="WebsiteTB" runat="server" TextMode="Url" class="w16 form-control"></asp:TextBox>
                                </div>
                                <div class="w20 single-input-fields">
