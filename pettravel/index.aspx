<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="pettravel.index" %>
    ...
    <body>
            ...
            <main>
                ...
                <!--Home Hero End -->
                <!--? services area start ->
        <section class="services-section section-padding30">
            <div class="container">
                ...
                <div class="services-active">
                    ...
                    <div class="single-cat mb-30">
                        ...
                        <div class="cat-cap text-center">
                            <h5><a href="services.html">Restaurant</a></h5>
                            <p>20 Listing</p>
                        </div>
                    </div>
                    <div class="single-cat mb-30">
                        ...
                        <div class="cat-cap text-center">
                            <h5><a href="services.html">Cafe</a></h5>
                            <p>20 Listing</p>
                        </div>
                    </div>
                    <div class="single-cat mb-30">
        ...
        <div class="popular-directorya-area  section-padding40">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <!-- Section Tittle ->
                ...
                <div class="row">
                        ...
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay3">
                                    ...
                                    <div class="icon">
                                        <img src="assets/img/icon/categori_icon1.png" alt=""> 
                                    </div>
                                </div>
                                ...
                                <div class="properties__footer d-flex justify-content-between align-items-center">
                                    <div class="restaurant-name">
                                        <img src="assets/img/icon/restaurant-icon.png" alt="">
                        ...
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay3">
                                    ...
                                    <div class="icon">
                                        <img src="assets/img/icon/categori_icon2.png" alt=""> 
                                    </div>
                                </div>
                                <div class="properties__caption">
                                    <h3><a href="#">Urban areas</a></h3>
                        ...
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay3">
                                    ...
                                    <div class="icon">
                                        <img src="assets/img/icon/categori_icon3.png" alt=""> 
                                    </div>
                                </div>
                                <div class="properties__caption">
                                    <h3><a href="#">Urban areas</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay3">
                                    <a href="#"><img src="assets/img/gallery/properties4.png" alt=""></a>
                                    <div class="img-text">
                                        <span>$$$</span>
                                        <span>Closed</span>
                                    </div>
                                    <div class="icon">
                                        <img src="assets/img/icon/categori_icon4.png" alt=""> 
                                    </div>
                                </div>
                                <div class="properties__caption">
                                    <h3><a href="#">Urban areas</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay3">
                                    <a href="#"><img src="assets/img/gallery/properties5.png" alt=""></a>
                                    <div class="img-text">
                                        <span>$$$</span>
                                        <span>Closed</span>
                                    </div>
                                    <div class="icon">
                                        <img src="assets/img/icon/categori_icon5.png" alt=""> 
                                    </div>
                                </div>
                                <div class="properties__caption">
                                    <h3><a href="#">Urban areas</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay3">
                                    <a href="#"><img src="assets/img/gallery/properties6.png" alt=""></a>
                                    <div class="img-text">
                                        <span>$$$</span>
                                        <span class="open">Open Now</span>
                                    </div>
                                    <div class="icon">
                                        <img src="assets/img/icon/categori_icon6.png" alt=""> 
                                    </div>
                                </div>
                                <div class="properties__caption">
                                    <h3><a href="#">Urban areas</a></h3>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-all text-center mt-20">
                            <a href="#" class="border-btn">Explore More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Popular Directory End -->
                <!--? Services Start ->
        <div class="our-services2 section-bg2 " data-background="assets/img/gallery/section_bg01.png">
            <div class="our-services2-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- Section Tittle ->
                            <div class="section-tittle mb-50">
                                ...
                                <h2>How Listio Work</h2>
                                <p>Explore Our Process</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
