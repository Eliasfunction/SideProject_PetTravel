<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="pettravel.contact" %>
    <!doctype html>
    ...
    <body>
        <form id="form1" runat="server" method="post">
                            ...
                            <div id="map" style="height: 480px; position: relative; overflow: hidden;">
                                <div
                                    ...
                                    <div class="gm-style"
                                        ...
                                        <div tabindex="0"
                                            style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; cursor: url(&quot;https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3682.506331420022!2d120.29980731427493!3d22.634902936386734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x346e048b7245d061%3A0x24ac679bd8c7aa5c!2z6IGv5oiQ6Zu76IWmLemrmOmbhOiqjeitieS4reW_gw!5e0!3m2!1szh-TW!2stw!4v1626279280570!5m2!1szh-TW!2stw;), default; touch-action: pan-x pan-y;">
                                            <div
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <asp:TextBox ID="MessageTB" class="form-control w-100" runat="server" TextMode="MultiLine" placeholder=" Enter Message" Height="1000px"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <asp:TextBox ID="NameTB" class="form-control valid" runat="server" placeholder="Your Name"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <asp:TextBox ID="EmailTB" class="form-control valid" runat="server" placeholder="Your Email" TextMode="Email"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <asp:TextBox ID="SubjectTB" class="form-control" runat="server" placeholder="Enter Subject"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mt-3">
                                        <asp:Button ID="SendBT" runat="server" Text="Send" class="button button-contactForm boxed-btn" OnClick="Send_Click"/>
                                    </div>
                                </div>
                            </div>
            ...
            <script src="http://maps.google.com/maps/api/js?key=AIzaSyDscnQQg2AuNRIRstkqDv-uL-TxQ9Sh8LU"></script>
            </form>  
    </body>
