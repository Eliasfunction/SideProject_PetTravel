<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="favorite_listing.aspx.cs" Inherits="pettravel.favorite_listing" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/css/heart-btn.css">
    </head>
                                ...
                                <div class="category-listing mb-50">
                                    ...
                                    <div class="single-listing">
                                        ...
                                        <div class="select-job-items2">
                                            <!--<select name="select2" class="nice-select">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="count mb-35">
                                            &nbsp<asp:Label ID="LblRightContent" runat="server" Text="目前收藏了  個景點">
                                            </asp:Label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="properties pb-30">
                                                <div class="properties__card">
                                                    <div class="properties__img overlay3">
                                                        <!--店家圖片-->
                                                        <a>
                                                            <asp:Image id="Img1spic1" runat="server"
                                                                Height="192.4px" Width="370px"></asp:Image>
                                                        </a>
                                                        <div class="img-text">
                                                            <!--特點標籤-->
                                                            <asp:Label id="Lbl1sfeature1" Text=" " runat="server" />
                                                            <p>
                                                                <asp:Label id="Lbl1sfeature2" Text=" " runat="server" />
                                                            <p>
                                                        </div>
                                                        <div class="icon">
                                                            <asp:Image ID="Img1iconspic2" runat="server"
                                                               imageurl="assets/img/icon/categori_icon1.png" alt="">
                                                            </asp:Image>
                                                        </div>
                                                    </div>
                                                    <div class="properties__caption">
                                                        <h3>
                                                            <asp:LinkButton id="LkBtn1sname" Text=" " runat="server"
                                                                OnClick="LkBtn1sname_Click" />
                                                        </h3>
                                                        <asp:Label id="Lbl1smessage" Text=" " runat="server" />
                                                        <p>
                                                    </div>
                                                    <div
                                                        class="properties__footer d-flex justify-content-between align-items-center">
                                                        <div class="restaurant-name">
                                                            <asp:Image ID="Img1spic3" runat="server"
                                                                 alt="">
                                                            </asp:Image>
                                                            <!--旅遊景點-->
                                            ...
                                            <div class="properties pb-30">
                                                <div class="properties__card">
                                                    <div class="properties__img overlay3">
                                                        <!--店家圖片-->
                                                        <a>
                                                            <asp:Image id="Img2spic1" runat="server"
                                                                Height="192.4px" Width="370px"></asp:Image>
                                                        </a>
                                                        <div class="img-text">
                                                            <!--特點標籤-->
                                                            <asp:Label id="Lbl2sfeature1" Text=" " runat="server" />
                                                            <p>
                                                                <asp:Label id="Lbl2sfeature2" Text=" " runat="server" />
                                                            <p>
                                                        </div>
                                                        <div class="icon">
                                                            <asp:Image ID="Img2iconspic2" runat="server"
                                                                imageurl="assets/img/icon/categori_icon1.png" alt="">
                                                            </asp:Image>
                                                        </div>
                                                    </div>
                                                    <div class="properties__caption">
                                                        <h3>
                                                            <asp:LinkButton id="LkBtn2sname" Text=" " runat="server"
                                                                OnClick="LkBtn2sname_Click" />
                                                        </h3>
                                                        <asp:Label id="Lbl2smessage" Text=" " runat="server" />
                                                        <p>
                                                    </div>
                                                    <div
                                                        class="properties__footer d-flex justify-content-between align-items-center">
                                                        <div class="restaurant-name">
                                                            <asp:Image ID="Img2spic3" runat="server"
                                                                 alt="">
                                                            </asp:Image>
                                                            <!--旅遊景點-->
                                            ...
                                            <div class="properties pb-30">
                                                <div class="properties__card">
                                                    <div class="properties__img overlay3">
                                                        <!--店家圖片-->
                                                        <a>
                                                            <asp:Image id="Img3spic1" runat="server"
                                                                Height="192.4px" Width="370px"></asp:Image>
                                                        </a>
                                                        <div class="img-text">
                                                            <!--特點標籤-->
                                                            <asp:Label id="Lbl3sfeature1" Text=" " runat="server" />
                                                            <p>
                                                                <asp:Label id="Lbl3sfeature2" Text=" " runat="server" />
                                                            <p>
                                                        </div>
                                                        <div class="icon">
                                                            <asp:Image ID="Img3iconspic2" runat="server"
                                                                imageurl="assets/img/icon/categori_icon1.png" alt="">
                                                            </asp:Image>
                                                        </div>
                                                    </div>
                                                    <div class="properties__caption">
                                                        <h3>
                                                            <asp:LinkButton id="LkBtn3sname" Text=" " runat="server"
                                                                OnClick="LkBtn3sname_Click" />
                                                        </h3>
                                                        <asp:Label id="Lbl3smessage" Text=" " runat="server" />
                                                        <p>
                                                    </div>
                                                    <div
                                                        class="properties__footer d-flex justify-content-between align-items-center">
                                                        <div class="restaurant-name">
                                                            <asp:Image ID="Img3spic3" runat="server"
                                                                 alt="">
                                                            </asp:Image>
                                                            <!--旅遊景點-->
                                            ...
                                            <div class="properties pb-30">
                                                <div class="properties__card">
                                                    <div class="properties__img overlay3">
                                                        <!--店家圖片-->
                                                        <a>
                                                            <asp:Image id="Img4spic1" runat="server"
                                                                Height="192.4px" Width="370px"></asp:Image>
                                                        </a>
                                                        <div class="img-text">
                                                            <!--特點標籤-->
                                                            <asp:Label id="Lbl4sfeature1" Text=" " runat="server" />
                                                            <p>
                                                                <asp:Label id="Lbl4sfeature2" Text=" " runat="server" />
                                                            <p>
                                                        </div>
                                                        <div class="icon">
                                                            <asp:Image ID="Img4iconspic2" runat="server"
                                                                imageurl="assets/img/icon/categori_icon1.png" alt="">
                                                            </asp:Image>
                                                        </div>
                                                    </div>
                                                    <div class="properties__caption">
                                                        <h3>
                                                            <asp:LinkButton id="LkBtn4sname" Text=" " runat="server"
                                                                OnClick="LkBtn4sname_Click" />
                                                        </h3>
                                                        <asp:Label id="Lbl4smessage" Text=" " runat="server" />
                                                        <p>
                                                    </div>
                                                    <div
                                                        class="properties__footer d-flex justify-content-between align-items-center">
                                                        <div class="restaurant-name">
                                                            <asp:Image ID="Img4spic3" runat="server"
                                                                 alt="">
                                                            </asp:Image>
                                                            <!--旅遊景點-->
                                            ...
                                            <div class="properties pb-30">
                                                <div class="properties__card">
                                                    <div class="properties__img overlay3">
                                                        <!--店家圖片-->
                                                        <a>
                                                            <asp:Image id="Img5spic1" runat="server"
                                                                Height="192.4px" Width="370px"></asp:Image>
                                                        </a>
                                                        <div class="img-text">
                                                            <!--特點標籤-->
                                                            <asp:Label id="Lbl5sfeature1" Text=" " runat="server" />
                                                            <p>
                                                                <asp:Label id="Lbl5sfeature2" Text=" " runat="server" />
                                                            <p>
                                                        </div>
                                                        <div class="icon">
                                                            <asp:Image ID="Im5iconspic2" runat="server"
                                                               imageurl="assets/img/icon/categori_icon1.png" alt="">
                                                            </asp:Image>
                                                        </div>
                                                    </div>
                                                    <div class="properties__caption">
                                                        <h3>
                                                            <asp:LinkButton id="LkBtn5sname" Text=" " runat="server"
                                                                OnClick="LkBtn5sname_Click" />
                                                        </h3>
                                                        <asp:Label id="Lbl5smessage" Text=" " runat="server" />
                                                        <p>
                                                    </div>
                                                    <div
                                                        class="properties__footer d-flex justify-content-between align-items-center">
                                                        <div class="restaurant-name">
                                                            <asp:Image ID="Img5spic3" runat="server"
                                                                 alt="">
                                                            </asp:Image>
                                                            <!--旅遊景點-->
                                            ...
                                            <div class="properties pb-30">
                                                <div class="properties__card">
                                                    <div class="properties__img overlay3">
                                                        <!--店家圖片-->
                                                        <a>
                                                            <asp:Image id="Img6spic1" runat="server"
                                                                Height="192.4px" Width="370px"></asp:Image>
                                                        </a>
                                                        <div class="img-text">
                                                            <!--特點標籤-->
                                                            <asp:Label id="Lbl6sfeature1" Text=" " runat="server" />
                                                            <p>
                                                                <asp:Label id="Lbl6sfeature2" Text=" " runat="server" />
                                                            <p>
                                                        </div>
                                                        <div class="icon">
                                                            <asp:Image ID="Img6iconspic2" runat="server"
                                                                imageurl="assets/img/icon/categori_icon1.png" alt="">
                                                            </asp:Image>
                                                        </div>
                                                    </div>
                                                    <div class="properties__caption">
                                                        <h3>
                                                            <asp:LinkButton id="LkBtn6sname" Text=" " runat="server"
                                                                OnClick="LkBtn6sname_Click" />
                                                        </h3>
                                                        <asp:Label id="Lbl6smessage" Text=" " runat="server" />
                                                        <p>
                                                    </div>
                                                    <div
                                                        class="properties__footer d-flex justify-content-between align-items-center">
                                                        <div class="restaurant-name">
                                                            <asp:Image ID="Img6spic3" runat="server"
                                                                alt="">
                                                            </asp:Image>
                                                            <!--旅遊景點-->
                                                ...
                                                <div class="single-wrap d-flex justify-content-center">
                                                    <nav aria-label="Page navigation example">
                                                        <ul class="pagination justify-content-start " id="myDIV">
                                                            ...
                                                            <li class="page-item">
                                                                <asp:LinkButton class="page-link" ID="LkBtnpagelett"
                                                                    Text="" runat="server"
                                                                    OnClick="LkBtnpagelett_Click"><span
                                                                        class="ti-angle-left"></span></asp:LinkButton>
                                                            </li>
                                                            <li class="page-item">
                                                                <asp:LinkButton class="page-link" ID="LkBtnpage1"
                                                                    Text="1" runat="server" OnClick="LkBtnpage1_Click">
                                                                </asp:LinkButton>
                                                            </li>
                                                            <li class="page-item">
                                                                <asp:LinkButton class="page-link" ID="LkBtnpage2"
                                                                    Text="2" runat="server" OnClick="LkBtnpage2_Click">
                                                                </asp:LinkButton>
                                                            </li>
                                                            <li class="page-item">
                                                                <asp:LinkButton class="page-link" ID="LkBtnpage3"
                                                                    Text="3" runat="server" OnClick="LkBtnpage3_Click">
                                                                </asp:LinkButton>
                                                            </li>
                                                            <li class="page-item">
                                                                <asp:LinkButton class="page-link" ID="LkBtnpageright"
                                                                    Text="" runat="server"
                                                                    OnClick="LkBtnpageright_Click"><span
                                                                        class="ti-angle-right"></span></asp:LinkButton>
                                                            </li>
                                                        </ul>
                                                    </nav>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="input_wrap">
                                            ...
                                            <input class="input_form" name="input_form9"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="finish-Listing text-center">
                                            ...
                                            <h3>Thanks!</h3>
                                            <p>You Are Almost There. Please Check If You Have Provided All The Necessary
                                                Things.</p>
                                        </div>
                                    </div>
                                </div>
